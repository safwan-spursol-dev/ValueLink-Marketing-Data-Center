<footer class="footer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <script>document.write(new Date().getFullYear())</script> © VMDC.
            </div>
            <div class="col-sm-6">
                <div class="text-sm-end d-none d-sm-block">
                    Design & Develop by Safwan
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="d-flex gap-2 flex-wrap img-switch">
                        ...
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                <img src="<?php echo BASE_URL; ?>assets/images/sidebar/img-1.jpg" alt=""
                        ...
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                <img src="<?php echo BASE_URL; ?>assets/images/sidebar/img-2.jpg" alt=""
                                    class="avatar-md w-auto object-fit-cover">
                            </label>
                        </div>
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                <img src="<?php echo BASE_URL; ?>assets/images/sidebar/img-3.jpg" alt=""
                                    class="avatar-md w-auto object-fit-cover">
                            </label>
                        </div>
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                <img src="<?php echo BASE_URL; ?>assets/images/sidebar/img-4.jpg" alt=""
                                    class="avatar-md w-auto object-fit-cover">
                            </label>
                        </div>
                    </div>
...
<?php 
// Sirf tab script load karo jab User ID set ho AUR hum Login page par na hon
if (isset($_SESSION['user_id']) && basename($_SERVER['PHP_SELF']) !== 'login.php'): 
?>

<script>
    // =================================================
    // 🛡️ REAL-TIME BAN CHECKER (Every 5 Seconds)
    // =================================================
    setInterval(function() {
        fetch('<?php echo BASE_URL; ?>check_status.php')
            .then(response => response.json())
            .then(data => {
                // 🛑 Logic Fix: Sirf tab action lo jab status explicitly 'banned' ho
                if (data.status === 'banned') {
                    alert("🚫 Your account has been suspended by the Administrator.");
                    window.location.href = "auth/login.php?err=banned"; 
                }
                // Agar status 'guest' ya 'active' hai to kuch mat karo
            })
            .catch(error => {
                // Error aye to chup raho (console me dikhao bas)
                console.error('Status check skipped:', error);
            });
    }, 5000); // 5 Seconds
</script>
